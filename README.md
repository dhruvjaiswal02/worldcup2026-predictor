...
| Tab | What It Shows |
|-----|---------------|
| 📊 Championship Odds | Bar chart of win probabilities for all 48 teams with full rankings table |
| 🗂️ Stage Breakdown | Heatmap showing each team's probability of reaching R32, R16, QF, SF, Final |
| 🌍 Groups | All 12 groups with each team's qualification probability |
| 📈 Team Ratings | Stacked bar chart of Base Elo + Squad Boost for all 48 teams |
| ⚡ Upset Radar | Most likely shock results in the group stage ranked by probability |
| 🏆 Live Bracket | Simulate a full tournament run and watch every match round by round |
| ⚽ Head-to-Head | Instant win/draw/loss odds for any two teams (sidebar) |

---

*Predictions are probabilistic and for analytical purposes only. Elo ratings trained on 51,491 international matches from 1872–2026.*
